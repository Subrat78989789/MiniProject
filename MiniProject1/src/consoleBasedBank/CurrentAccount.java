...
public CurrentAccount(long accNo, String holderName, double balance) {
	super(accNo, holderName, balance,CurrentAccount.class);//CurrentAccount.class returns <consoleBasedBank.CurrentAccount>
	// TODO Auto-generated constructor stub
}
public void calculateInterest() {
	
	double interest=(double)15/100;//due to we extend Account we can access all members thats why balance is accessed
